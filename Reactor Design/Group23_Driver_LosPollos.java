...
public class Group23_Driver_LosPollos{
  ...
  public static void main(String[] args){
    ...
    if(species1==0 || species2==0 || species3==0 ){
      System.out.println("Stoichiometry is invalid.");
    ...
    if(kA == 0 || V == 0 || vO == 0 || (FaO == 0 && FbO == 0) ){
      System.out.println("With no flow in the system, or a reaction to occur, it can not operate; please try again.");
      System.out.println("Exiting...");
      System.exit(0);
    }
    ...
    if(rk4Test == 1){
    System.out.println("\n-----------------------------------------------------------------");
    System.out.println("Calculated using RK4 Method.");
    System.out.println("-----------------------------------------------------------------");
    System.out.println("Solving ODE using RK4 Method with intial step size of " + h+".");
    
    RK4_adaptive rk4 = new RK4_adaptive(reactor1, h);
    long rk4Start = System.nanoTime();
    double convX = rk4.solveODE(0.,0.,600.)*100;
    long rk4Stop = System.nanoTime();
    
    System.out.println("\nFinal conversion achieved.");
    System.out.println("Time to solve: " + (rk4Stop-rk4Start)/(Math.pow(10,6)) + " ms");
    ...
    System.out.println("-----------------------------------------------------------------");
    scanner.close();
   // Commented out code below is for Excel and Scheme comparisons in place of a CSV output
   // System.out.println("Cb,out = " + rxn1.getiConc()[1]);
   // System.out.println("Conversion of B = " + convX);
   // System.out.println("Reaction rate for B at exit = " + rxn1.calculateReactionRate(convX/100,flowParameters));
   // System.out.println("dX/dV at exit = " + rxn1.calculateReactionRate(convX/100,flowParameters)/FbO);
    }
  }
